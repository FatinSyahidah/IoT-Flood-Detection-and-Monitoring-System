...
export class QueryHum2 extends React.Component{
    constructor(){
        super();
        this.state = {
            tableData: []
    ...
    componentDidMount(){
        ...
        onValue(que, (snapshot) => {
            ...
            snapshot.forEach(childSnapshot => {
                ...
                hum.push({"key": key, "data":data});
            });
            //AddAllItemsToTable(temps);
            this.setState({tableData: hum});
        });
                ...
                {this.state.tableData.map((row,index)=>{
                    ...
                    <tr>
                        ...
                        <CircularProgressbar
                            ...
                            value= {row.data.Humidity.toFixed(2)} 
                            text={`${row.data.Humidity.toFixed(2)} %`}
                            circleRatio={1}
                            styles={{
